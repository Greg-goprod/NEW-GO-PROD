...
Write-Host "Calling queue-stats v50..."
$response = Invoke-RestMethod -Uri "https://alhoefdrjbwdzijizrxc.supabase.co/functions/v1/queue-stats" -Method POST -Headers $headers -Body $body -TimeoutSec 300
